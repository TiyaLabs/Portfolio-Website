...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/90 dark:bg-slate-900/90 backdrop-blur-md py-4 shadow-sm border-b border-slate-200 dark:border-slate-800' : 'bg-transparent py-8'
      }`}
    >
